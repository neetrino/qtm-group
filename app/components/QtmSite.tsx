...
function Footer() {
  return <footer className="footer"><div className="container"><div className="footer-clean">
    ...
    <div><h3>Contact</h3><a href="mailto:info@qtm-group.com">info@qtm-group.com</a><a href="tel:+37443552522">+374 43 552522</a><p className="footer-address">Armenia Yerevan Margaryan str 2nd L, 1/24, 0078 postal code.</p></div>
    ...
    <section className="section about-story-section">
      <div className="container about-story-grid">
        ...
        <article className="about-story-feature" data-about-reveal>
          <figure className="about-story-image"><img src="/assets/about-team-working.webp" alt="QTM Group team supporting an industrial production line" /></figure>
        ...
        <article className="about-story-feature about-industries-feature" data-about-reveal>
          <div className="about-industries-gallery" aria-label="QTM Group industries and factory applications">
            {Array.from({length:6},(_,index)=><figure className="about-industries-tile" key={`about-gallery-${index+1}`}><img src={`/assets/about-uploaded/about-gallery-${String(index+1).padStart(2,"0")}.jpg`} alt={`QTM Group industrial application ${index+1}`} /></figure>)}
          </div>
        ...
        <article className="about-story-feature about-story-feature-reverse about-support-feature" data-about-reveal>
          <div className="about-support-gallery" aria-label="QTM Group technical support and industrial visits">
            {Array.from({length:7},(_,index)=><figure className="about-support-tile" key={`about-support-${index+1}`}><img src={`/assets/about-uploaded/about-support-${String(index+1).padStart(2,"0")}.jpg`} alt={`QTM Group technical support visit ${index+1}`} /></figure>)}
          </div>
...
const vBeltFamilies=[
  ...
  {name:"Rubber Raw Edge",href:"/products/v-belts/rubber-raw-edge",image:"/assets/vbelt-varisect-link.png",copy:"Raw edge cogged construction for improved flexibility, higher power density and compact drives."},
...
const rawEdgeProfileImages={
  varisect:"/assets/official-varisect-profile.jpg",
  xpz:"/assets/official-xpz.jpg",
  xpa:"/assets/official-xpa.jpg",
  xpb:"/assets/official-xpb.jpg",
  xpc:"/assets/official-xpc.jpg",
  contiVx:"/assets/official-contiVxAdvanced.jpg",
  contiV:"/assets/official-contiV.jpg",
};
const megadyneDam=(id:string)=>`https://dam.ammega.com/api/file/redirect/${id}`;
const wrappedVImages={
  oleostaticGold:"/assets/wrapped-oleostatic-gold.png",
  oleostatic:"/assets/wrapped-oleostatic.png",
  extra:"/assets/partnership-megadyne-vbelts-extra.png",
  esaflex:"/assets/wrapped-esaflex.png",
  xdv2Mxv:"/assets/wrapped-xdv2-mxv.png",
};
const wrappedVProfiles={
  z:"/assets/vbelt-profiles/wrapped-z.svg",
  a:"/assets/vbelt-profiles/wrapped-a.svg",
  b:"/assets/vbelt-profiles/wrapped-b.svg",
  c:"/assets/vbelt-profiles/wrapped-c.svg",
  d:"/assets/vbelt-profiles/wrapped-d.svg",
  e:"/assets/vbelt-profiles/wrapped-e.svg",
  spz:"/assets/vbelt-profiles/wrapped-spz.svg",
  spa:"/assets/vbelt-profiles/wrapped-spa.svg",
  spb:"/assets/vbelt-profiles/wrapped-spb.svg",
  spc:"/assets/vbelt-profiles/wrapped-spc.svg",
  xdv2:"/assets/vbelt-profiles/wrapped-xdv2.svg",
  mxv:"/assets/vbelt-profiles/wrapped-mxv.svg",
};
const vBeltDetailPages={
  "rubber-wrapped":{titleTop:"Rubber",titleBottom:"Wrapped V-Belts",eyebrow:"",quote:"v-belts",heroImage:"/assets/rubber-wrapped-hero-requested.png",heroCopy:["Time-Proven Wrapped V-Belts - Sourced Through QTM","Rubber wrapped V-belts remain the standard choice for industrial power transmission worldwide, delivering consistent and dependable performance across thousands of established applications.","A textile wrap cover protects the rubber body against abrasion, oil and heat, while the internal cord provides reliable tensile strength across classical and narrow sections alike.","Through QTM, customers can access the Megadyne wrapped range: Oleostatic Gold, Oleostatic, Extra, Esaflex and XDV2/MXV."],profileTitle:"Rubber Wrapped Profile Range",profileCopy:"Standard wrapped sections covering light-duty to heavy industrial drives.",families:[{family:"Oleostatic Gold",official:"https://megadynegroup.com/en/products/v-belts/rubber-wrapped/oleostatic-gold/",linkImage:wrappedVImages.oleostaticGold,description:"Premium classical wrapped V-belt with oil- and heat-resistant compounds for demanding industrial drives.",profiles:[["Z",wrappedVProfiles.z],["A",wrappedVProfiles.a],["B",wrappedVProfiles.b],["C",wrappedVProfiles.c],["D",wrappedVProfiles.d]]},{family:"Oleostatic",official:"https://megadynegroup.com/en/products/v-belts/rubber-wrapped/oleostatic/",linkImage:wrappedVImages.oleostatic,description:"Standard classical wrapped V-belt offering reliable oil- and heat-resistant performance for general industrial use.",profiles:[["Z",wrappedVProfiles.z],["A",wrappedVProfiles.a],["B",wrappedVProfiles.b],["C",wrappedVProfiles.c],["D",wrappedVProfiles.d],["E",wrappedVProfiles.e]]},{family:"Extra",official:"https://megadynegroup.com/en/products/v-belts/rubber-wrapped/extra/",linkImage:wrappedVImages.extra,description:"Wrapped narrow-section V-belt built for higher power density in compact industrial and agricultural drives.",profiles:[["SPZ",wrappedVProfiles.spz],["SPA",wrappedVProfiles.spa],["SPB",wrappedVProfiles.spb],["SPC",wrappedVProfiles.spc]]},{family:"Esaflex",official:"https://megadynegroup.com/en/products/v-belts/rubber-wrapped/esaflex/",linkImage:wrappedVImages.esaflex,description:"Flexible wrapped narrow V-belt engineered for smooth running and dependable service life on standard drives.",profiles:[["SPZ",wrappedVProfiles.spz],["SPA",wrappedVProfiles.spa],["SPB",wrappedVProfiles.spb],["SPC",wrappedVProfiles.spc]]},{family:"XDV2/MXV",official:"https://megadynegroup.com/en/products/v-belts/rubber-wrapped/",linkImage:wrappedVImages.xdv2Mxv,description:"Wrapped variable-speed V-belt for adjustable-pulley transmission systems requiring smooth, continuous speed control.",profiles:[["XDV2",wrappedVProfiles.xdv2],["MXV",wrappedVProfiles.mxv]]}],benefits:["Proven reliability in industrial equipment","Protective textile cover","Cost-effective operation","Easy maintenance and replacement","Wide pulley compatibility"]},
  "rubber-raw-edge":{titleTop:"Rubber",titleBottom:"Raw Edge V-Belts",eyebrow:"MEGADYNE · CONTINENTAL · HIGH-POWER TRANSMISSION",quote:"v-belts",heroImage:"/assets/vbelt-varisect-link.png",heroCopy:["High-Power Raw Edge Belts - Sourced Through QTM","Raw edge V-belts expose the rubber sidewall directly to the pulley groove, increasing friction and gripping force for higher power-transmission capacity than wrapped constructions.","Cogged inner profiles improve flexibility, reduce bending stress and support compact pulley layouts while maintaining dependable power transfer.","Through QTM, customers can access Megadyne raw edge products, the MegaV performance platform and Continental raw edge V-belt ranges for demanding industrial drives."],profileTitle:"Rubber Raw Edge Profile Range",profileCopy:"Raw edge and cogged sections engineered for compact, high-power drives.",families:[
    {family:"Varisect",official:"https://megadynegroup.com/en/products/v-belts/rubber-raw-edge/varisect/",linkImage:"/assets/vbelt-varisect-link.png",description:"Raw edge variable-speed V-belt engineered to maintain grip and consistent power transmission across adjustable pulley systems.",profiles:[["28x8",rawEdgeProfileImages.varisect],["32x10",rawEdgeProfileImages.varisect],["37x10",rawEdgeProfileImages.varisect],["47x13",rawEdgeProfileImages.varisect]]},
    {family:"Linea Gold",official:"https://megadynegroup.com/en/products/v-belts/rubber-raw-edge/linea-gold/",linkImage:"/assets/vbelt-linea-gold-link.png",description:"Premium raw edge cogged V-belt with enhanced compounds for heavy-duty, high-temperature and high-load applications.",profiles:[["XPZ",rawEdgeProfileImages.xpz],["XPA",rawEdgeProfileImages.xpa],["XPB",rawEdgeProfileImages.xpb],["XPC",rawEdgeProfileImages.xpc]]},
    {sectionHeader:"MegaV",sectionCopy:"Megadyne MegaV raw edge belts are built for high-efficiency compact drives, combining strong tension members, precision tooth geometry and modern rubber compounds."},
    {family:"MEGAV Dynamic X",official:"https://megadynegroup.com/en/products/v-belts/rubber-raw-edge/megav-dynamic-x/",linkImage:"/assets/megav-dynamic-x.png",description:"High-performance raw edge cogged V-belt for compact, efficient industrial drives requiring strong grip and smooth running.",profiles:[["XPZ",rawEdgeProfileImages.xpz],["XPA",rawEdgeProfileImages.xpa],["XPB",rawEdgeProfileImages.xpb],["XPC",rawEdgeProfileImages.xpc]]},
    {family:"MEGAV Dynamic Max",badge:"NEW PRODUCT",official:"https://megadynegroup.com/en/products/v-belts/rubber-raw-edge/megav-dynamic-max/",linkImage:"/assets/vbelt-dynamic-max-link.png",description:"Newest MegaV raw edge cogged belt, developed for maximum performance, high power density and long service life in demanding drives.",profiles:[["XPZ",rawEdgeProfileImages.xpz],["XPA",rawEdgeProfileImages.xpa],["XPB",rawEdgeProfileImages.xpb],["XPC",rawEdgeProfileImages.xpc]]},
    {sectionHeader:"ContiTech Raw Edge V-Belts",sectionLabel:"Continental Raw Edge Range",sectionCopy:"Continental raw edge V-belts provide premium power transmission performance for compact industrial drives, with advanced compounds and profile options for heavy-duty applications."},
    {family:"CONTI® VX Torque Team Advance",official:"https://www.continental-industry.com/global/en/products-solutions/power-transmission/v-belts",linkImage:"/assets/conti-vx-advanced-link.png",description:"Advanced Continental raw edge cogged V-belt for demanding torque transmission, compact pulley layouts and high-efficiency industrial drives.",profiles:[["AVX10",rawEdgeProfileImages.contiVx],["AVX13",rawEdgeProfileImages.contiVx],["AVX17",rawEdgeProfileImages.contiVx],["XPZ",rawEdgeProfileImages.xpz],["XPA",rawEdgeProfileImages.xpa],["XPB",rawEdgeProfileImages.xpb]]},
    {family:"CONTI® V FO Pioneer",official:"https://www.continental-industry.com/global/en/products-solutions/power-transmission/v-belts",linkImage:"/assets/conti-v-fo-link.png",description:"Raw edge Continental V-belt for flexible, efficient power transmission where reliable grip and smooth running are required.",profiles:[["FO Z",rawEdgeProfileImages.contiV],["FO A",rawEdgeProfileImages.contiV],["FO B",rawEdgeProfileImages.contiV],["FO C",rawEdgeProfileImages.contiV]]},
  ],benefits:["Higher power density than wrapped belts","Improved flexibility","Reduced pulley diameter","High-speed capability","Modern machinery standard"]},
  "rubber-banded":{titleTop:"Rubber",titleBottom:"Banded V-Belts",eyebrow:"",quote:"v-belts",heroImage:"/assets/vbelt-pluriband-link.png",heroCopy:["Synchronized Multi-Belt Drives - Sourced Through QTM","Rubber banded V-belts consist of multiple individual belts rigidly bonded together along their length, keeping the strands aligned through demanding multi-pulley drive systems.","Factory-bonded construction helps the belts share load evenly, reducing slippage and uneven wear compared with loose multi-belt sets.","Through QTM, customers can access Megadyne Rubber Pluriband and Continental Torque Team banded V-belt ranges for heavy-duty machinery and industrial power transmission."],profileTitle:"Rubber Banded Profile Range",profileCopy:"Bonded multi-belt sections available across classical, narrow and high-power banded profiles.",families:[{family:"Rubber Pluriband",official:"https://megadynegroup.com/en/products/v-belts/rubber-banded/pluriband/",linkImage:"/assets/vbelt-pluriband-link.png",description:"Factory-bonded multi-belt construction for synchronized power transmission across heavy-duty, multi-pulley drive systems.",profiles:[["Banded A",wrappedVProfiles.a],["Banded B",wrappedVProfiles.b],["Banded C",wrappedVProfiles.c],["Banded SPA",wrappedVProfiles.spa],["Banded SPB",wrappedVProfiles.spb],["Banded SPC",wrappedVProfiles.spc]]},{sectionHeader:"Continental Torque Team Banded V-Belts",sectionLabel:"Continental Banded Range",sectionCopy:"Continental banded V-belts are built for drives with shock loads, pulsating loads and long center distances where joined strands help keep the belt set stable."},{family:"CONTI® V Torque Team",official:"https://www.continental-industry.com/global/en/products-solutions/power-transmission/v-belts",linkImage:"/assets/partnership-conti-v.jpg",description:"Standard Continental banded wrapped V-belt range for reliable multi-strand power transmission in demanding industrial drives.",profiles:[["A",wrappedVProfiles.a],["B",wrappedVProfiles.b],["C",wrappedVProfiles.c],["D",wrappedVProfiles.d],["3V / 9J",wrappedVProfiles.spz],["5V / 15J",wrappedVProfiles.spb],["8V / 25J",wrappedVProfiles.spc],["SPZ",wrappedVProfiles.spz],["SPA",wrappedVProfiles.spa],["SPB",wrappedVProfiles.spb],["SPC",wrappedVProfiles.spc]]},{family:"CONTI® V Torque Team Advance",official:"https://www.continental-industry.com/global/en/products-solutions/power-transmission/v-belts",linkImage:"/assets/official-contiV.jpg",description:"Advanced Continental banded wrapped V-belt construction for higher power capacity and stable performance under heavy load changes.",profiles:[["5V / 15J ADV",wrappedVProfiles.spb],["8V / 25J ADV",wrappedVProfiles.spc],["SPB ADV",wrappedVProfiles.spb],["SPC ADV",wrappedVProfiles.spc]]},{family:"CONTI® VX Torque Team Advance",official:"https://www.continental-industry.com/global/en/products-solutions/power-transmission/v-belts",linkImage:"/assets/conti-vx-advanced-link.png",description:"Raw-edge cogged Continental banded V-belt range for powerful compact drives requiring strong grip, flexibility and stable strand alignment.",profiles:[["3VX / 9JX ADV",rawEdgeProfileImages.contiVx],["5VX / 15JX ADV",rawEdgeProfileImages.contiVx],["XPB ADV",rawEdgeProfileImages.xpb]]}],benefits:["Perfect synchronization","Even load distribution","No belt slippage","Consistent power transmission","Reduced maintenance"]},
} as const;
...
function VBeltDetailPage({slug}:{slug:VBeltDetailSlug}){const page=vBeltDetailPages[slug];useEffect(()=>{const elements=Array.from(document.querySelectorAll<HTMLElement>("[data-openend-reveal]"));if(window.matchMedia("(prefers-reduced-motion: reduce)").matches||!("IntersectionObserver" in window)){elements.forEach(element=>element.classList.add("is-visible"));return}const observer=new IntersectionObserver(entries=>entries.forEach(entry=>{if(entry.isIntersecting){entry.target.classList.add("is-visible");observer.unobserve(entry.target)}}),{threshold:.1,rootMargin:"0px 0px -8%"});elements.forEach(element=>observer.observe(element));return()=>observer.disconnect()},[]);return <>
  ...
  <section className="section openend-profiles" data-openend-reveal><div className="container"><div className="openend-section-head"><p className="eyebrow"><b>PROFILE RANGE</b></p><h2>{page.profileTitle}</h2><p>{page.profileCopy}</p></div><div className="openend-profiles-intro"><h2>Profiles</h2><p>With our extensive selection of <strong>V-belts</strong>, QTM covers most of the profiles commonly used across the <strong>belting industry</strong>, providing solutions for a wide range of industrial applications.</p></div><div className="openend-profile-catalog">{page.families.map((family:any)=>"sectionHeader" in family?<div className={`vbelt-section-header${family.sectionHeader.toLowerCase().includes("conti")?" vbelt-section-header--conti":""}`} key={family.sectionHeader}><span>{family.sectionLabel??(family.sectionHeader.toLowerCase().includes("conti")?"Continental Raw Edge Range":"Premium Raw Edge Platform")}</span><h3>{family.sectionHeader}</h3><p>{family.sectionCopy}</p></div>:<section className="openend-profile-family" key={family.family}><div className="openend-profile-family-head"><h3>{family.family}</h3>{family.badge&&<span className="vbelt-new-badge">{family.badge}</span>}</div><a className={`openend-profile-official openend-profile-official--media${family.badge?" vbelt-new-product-link":""}`} href={family.official} target="_blank" rel="noreferrer"><span className="openend-profile-link-image"><img src={family.linkImage} alt="" loading="lazy" decoding="async"/></span><span className="openend-profile-link-copy"><strong>{family.family}</strong><span>{family.description}</span></span><Arrow/></a><div className="openend-profile-picture-grid">{family.profiles.map((profile:any)=>{const profileName=Array.isArray(profile)?profile[0]:profile;const profileImage=Array.isArray(profile)?profile[1]:family.linkImage;return <figure key={`${family.family}-${profileName}`}><img src={profileImage} alt={`${family.family} ${profileName} V-belt profile`} loading="lazy" decoding="async"/><figcaption>{profileName}</figcaption></figure>})}</div></section>)}</div></div></section>
...
const contiRubberOfficial="https://www.continental-industry.com/gb/en/products-solutions/power-transmission/synchronous-belts-rubber";
const contiRubberImages={
  synchrobelt:"/assets/conti-clean/synchrobelt-requested.png",
  synchroforce:"/assets/conti-clean/ff2ebecf-ebdd-48bb-b901-2eefaa9d5ae1.png",
  synchroforceAdvance:"/assets/conti-clean/cc335f88-0997-4a20-a70f-e75ee0e1dfff.png",
  synchroforceCxp:"/assets/conti-clean/95511366-750c-4c35-871e-b2a7a3703d52.png",
  synchroforceCarbon:"/assets/conti-clean/carbon-requested.png",
  synchroforceExtreme:"/assets/conti-clean/synchrobelt-requested.png",
  silentSync:"/assets/official-conti-rubber-silentSync.jpg",
  falconPd:"/assets/official-conti-rubber-falconPd.jpg",
  synchrotwin:"/assets/official-conti-rubber-synchrotwin.avif",
  synchrolineCxp:"/assets/conti-clean/synchroline-clean.png",
  synchroforceRib:"/assets/conti-clean/rib-advance-requested.png",
  range:"/assets/conti-clean/rubber-range-clean.jpeg",
};
...
const rubberOpenEndProfilePictures=[
  ...
  {family:"CONTI® SYNCHROLINE CXP",official:contiRubberOfficial,linkImage:contiRubberImages.synchrolineCxp,description:"Chloroprene open-ended Continental rubber timing belts for automatic door entry systems and accurate linear movement.",profiles:[["HTD 5M ADV","https://dam.ammega.com/api/file/redirect/05d9fa86-ef72-4406-801c-0ed4010e7aff"]]},
  {family:"CONTI® SYNCHROFORCE LINE ADVANCE",official:contiRubberOfficial,linkImage:contiRubberImages.synchroforceAdvance,description:"EPDM open-ended Continental rubber timing belts for automatic door entry systems and higher-performance linear drives.",profiles:[["HTD 8M ADV","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"]]},
...
const rubberEndlessProfilePictures=[
  ...
  {family:"CONTI® SYNCHROBELT",official:contiRubberOfficial,linkImage:contiRubberImages.synchrobelt,description:"Standard Continental rubber synchronous belts for accurate power transmission in established industrial drives.",profiles:[["MXL","https://dam.ammega.com/api/file/redirect/143d56d6-4736-4e6c-8cce-fcdeb3cbe4b0"],["XL","https://dam.ammega.com/api/file/redirect/be201cda-547e-4b22-8058-df9ba10debb5"],["L","https://dam.ammega.com/api/file/redirect/0ccfcfcd-ab69-48f1-929f-4e47859e1e6b"],["H","https://dam.ammega.com/api/file/redirect/00c58aa0-1656-4f05-93a7-3ba63835342d"],["XH / XXH","https://dam.ammega.com/api/file/redirect/90514e76-ac86-4eb4-b1bd-1c8ebd91462f"],["HTD 3M / 5M","https://dam.ammega.com/api/file/redirect/05d9fa86-ef72-4406-801c-0ed4010e7aff"],["HTD 8M / 14M","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["STD S2M / S3M / S5M / S8M / S14M","https://dam.ammega.com/api/file/redirect/39b477fc-73cc-441e-8052-decee2dad456"]]},
  {family:"CONTI® SYNCHROFORCE CXP",official:contiRubberOfficial,linkImage:contiRubberImages.synchroforceCxp,description:"CXP-grade Continental rubber timing belts for higher performance synchronous drives and improved load capacity.",profiles:[["HTD 3M ADV / 5M ADV","https://dam.ammega.com/api/file/redirect/05d9fa86-ef72-4406-801c-0ed4010e7aff"],["HTD 8M ADV / 14M ADV","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"]]},
  {family:"CONTI® SYNCHROFORCE CXA",official:contiRubberOfficial,linkImage:"/assets/conti-clean/synchroforce-cxa-link.png",description:"Heavy-duty Continental timing belts for sustained transmission of higher torque levels at low speed.",profiles:[["HTD 8M CXA / HTD 14M CXA","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["STD S8M CXA","https://dam.ammega.com/api/file/redirect/39b477fc-73cc-441e-8052-decee2dad456"],["CTD C8M CXA","/assets/ctd-c8m-profile.jpg"]]},
  {family:"CONTI® SYNCHROFORCE ADVANCE",official:contiRubberOfficial,linkImage:contiRubberImages.synchroforceAdvance,description:"Advanced Continental rubber timing-belt range for demanding industrial drives requiring reliable torque transmission.",profiles:[["HTD 8M ADV","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["HTD 14M ADV","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["STD S8M ADV","https://dam.ammega.com/api/file/redirect/39b477fc-73cc-441e-8052-decee2dad456"]]},
  {family:"CONTI® SYNCHROFORCE ADVANCE PRO",official:contiRubberOfficial,linkImage:contiRubberImages.synchroforceAdvance,description:"Advance Pro construction for high-duty Continental synchronous drives where CTD and HTD profiles support stronger engagement.",profiles:[["HTD 8M ADV P","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["HTD 14M ADV P","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["STD S8M ADV P","https://dam.ammega.com/api/file/redirect/39b477fc-73cc-441e-8052-decee2dad456"],["CTD C8M ADV P","/assets/ctd-c8m-profile.jpg"]]},
  {family:"CONTI® SYNCHROFORCE CARBON",official:contiRubberOfficial,linkImage:contiRubberImages.synchroforceCarbon,description:"Carbon-reinforced Continental rubber timing belts for high dynamic loads, strong torque transmission and long service life.",profiles:[["HTD 8M SUP","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["STD S8M SUP","https://dam.ammega.com/api/file/redirect/39b477fc-73cc-441e-8052-decee2dad456"],["CTD C8M SUP","/assets/ctd-c8m-profile.jpg"]]},
  {family:"CONTI® SYNCHROFORCE EXTREME",official:contiRubberOfficial,linkImage:contiRubberImages.synchroforceExtreme,description:"Extreme-duty Continental rubber synchronous belt for very high-load industrial drives and robust HTD / CTD engagement.",profiles:[["HTD 14M EXT","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["CTD 14M EXT","/assets/ctd-c14m-profile.jpg"]]},
  {family:"CONTI® SILENTSYNC",official:contiRubberOfficial,linkImage:contiRubberImages.silentSync,description:"Continental SilentSync rubber timing belts use a helical tooth design for quiet, smooth and efficient synchronous power transmission.",profiles:[["Y - 8M 16","https://dam.ammega.com/api/file/redirect/05d9fa86-ef72-4406-801c-0ed4010e7aff"],["W - 8M 32","https://dam.ammega.com/api/file/redirect/05d9fa86-ef72-4406-801c-0ed4010e7aff"],["P - 8M 64","https://dam.ammega.com/api/file/redirect/05d9fa86-ef72-4406-801c-0ed4010e7aff"],["B - 14M 35","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["G - 14M 52.5","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["O - 14M 70","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["R - 14M 105","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"]]},
  {family:"CONTI® FALCON PD",official:contiRubberOfficial,linkImage:contiRubberImages.falconPd,description:"Falcon Pd rubber synchronous belts are designed for high power density, efficient engagement and demanding industrial drives.",profiles:[["GTR 8M","https://dam.ammega.com/api/file/redirect/05d9fa86-ef72-4406-801c-0ed4010e7aff"],["GTR 14M","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"]]},
  {family:"CONTI® SYNCHROTWIN",official:contiRubberOfficial,linkImage:contiRubberImages.synchrotwin,description:"Double-sided Continental rubber timing belts for drives that need synchronous engagement on both belt faces.",profiles:[["DHTD D5M","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"],["DHTD D8M","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"],["DHTD D14M","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"],["DSTD DS8M","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"],["DHTD D5M ADV","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"],["DHTD D8M ADV","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"],["DHTD D14M ADV","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"],["DSTD DS8M ADV","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"]]},
  {family:"CONTI® SYNCHROTWIN CXP",official:contiRubberOfficial,linkImage:contiRubberImages.synchrotwin,description:"CXP double-sided Continental rubber timing belts for higher-performance synchronized drives with tooth engagement on both faces.",profiles:[["DHTD D5M ADV","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"],["DHTD D8M ADV","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"],["DHTD D14M ADV","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"],["DSTD DS8M ADV","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"]]},
  {family:"CONTI® SYNCHROTWIN CXA",official:contiRubberOfficial,linkImage:contiRubberImages.synchrotwin,description:"CXA double-sided Continental timing-belt construction for advanced applications requiring controlled power transfer from both belt sides.",profiles:[["DHTD D8M AP","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"],["DHTD D14M AP","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"],["DSTD DS8M AP","https://dam.ammega.com/api/file/redirect/70438726-994f-46d5-acd7-35fccb8fa1e2"]]},




  {family:"CONTI® SYNCHROFORCE COLOR",official:contiRubberOfficial,linkImage:contiRubberImages.synchroforceAdvance,description:"Color-coded Continental rubber timing belts for quick identification and reliable synchronous transmission.",profiles:[["HTD 8M","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["HTD 14M","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"]]},
  {family:"CONTI® SYNCHROFORCE COLOR ADVANCE",official:contiRubberOfficial,linkImage:contiRubberImages.synchroforceAdvance,description:"Advance-grade color-coded Continental rubber timing belts for easier identification and higher-duty drive selection.",profiles:[["HTD 8M ADV","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["HTD 14M ADV","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"]]},
  {family:"CONTI® SYNCHROFORCE COLOR ADVANCE PRO",official:contiRubberOfficial,linkImage:contiRubberImages.synchroforceAdvance,description:"Advance Pro color-coded Continental timing belts for high-performance applications where fast identification and stronger engagement matter.",profiles:[["HTD 8M ADV P","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["HTD 14M ADV P","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"]]},
  {family:"CONTI® SYNCHROFORCE RIB ADVANCE | ADVANCE PRO",official:contiRubberOfficial,linkImage:contiRubberImages.synchroforceRib,description:"Ribbed Continental rubber synchronous belt range for high speeds with Advance and high-torque low-speed duties with Advance Pro.",profiles:[["HTD 8M ADV PK","https://dam.ammega.com/api/file/redirect/18941fb2-21c5-4b02-abf7-3ed7dae2f059"],["STD S8M ADV PK","https://dam.ammega.com/api/file/redirect/39b477fc-73cc-441e-8052-decee2dad456"]]},
] as const;

type TimingBeltDetailSlug = keyof typeof timingBeltDetailPages;

function TimingProfileFamily({family}:{family:any}){
  const imperialProfileGroup=new Set(["MXL","XL","L","H","XH","XXH","XH / XXH"]);
  const profileGroups=Object.values((family.profiles as [string,string][]).reduce((groups:Record<string,{src:string;names:string[]}>,[profile,src])=>{const key=imperialProfileGroup.has(profile)?"imperial-mxl-xl-l-h-xh-xxh":profile.startsWith("HTD ")?"htd-profiles":src;if(!groups[key])groups[key]={src,names:[]};groups[key].names.push(profile);return groups},{}));
  return <section className={`openend-profile-family${family.family==="CONTI® SYNCHROCHAIN Carbon"?" carbon-profile-family":""}`}>
    ...
    <div className={`openend-profile-picture-grid openend-profile-picture-grid--merged${profileGroups.length<=2?" openend-profile-picture-grid--center":""}`}>{profileGroups.map(group=><figure className="merged-profile-card" key={`${family.family}-${group.src}`}><img src={group.src} alt={`${family.family} ${group.names.join(", ")} timing belt profiles`} loading="lazy" decoding="async"/><figcaption>{group.names.join(" / ")}</figcaption></figure>)}</div>
...
function ContiRubberTechnical({family}:{family:string}){
  const isCxp=family==="CONTI® SYNCHROFORCE CXP";
  const isCxa=family==="CONTI® SYNCHROFORCE CXA";
  const isAdvance=family==="CONTI® SYNCHROFORCE ADVANCE";
  if(!isCxp&&!isCxa&&!isAdvance)return null;
  const data=isCxp?{
    image:"/assets/conti-clean/cxp-technical-preview-requested.png",
    title:"",
    alt:"CXP technical preview",
    items:["Polyamide fabric","Synthetic rubber teeth","Glass cord tension member","Synthetic rubber backing"]
  }:isCxa?{
    image:"/assets/conti-clean/synchroforce-cxa-structure.png",
    title:"",
    alt:"CONTI SYNCHROFORCE CXA product information",
    items:["Polyamide fabric","Synthetic rubber teeth","Aramid tension member","Synthetic rubber backing"],
    properties:["Temperature range from -20°C to +100°C, depending on application","PAH category 2 according to 2004/AFPS GS 2014:01","Electrically conductive in accordance with ISO 9563","Conditionally resistant to oil"],
    ranges:["HTD 8M CXA: 280-1800 mm","HTD 14M CXA: 966-4578 mm","STD S8M CXA: 480-2848 mm","CTD C8M CXA: 228-1260 mm"]
  }:{
    image:"/assets/conti-clean/advance-technical-preview-requested.png",
    title:"",
    alt:"Advance technical preview",
    items:["Protective low-friction polyamide fabric","Teeth made of aramid-fiber reinforced EPDM rubber","Glass-cord tension member","Backing made of aramid-fiber reinforced EPDM rubber"]
  };
  return <section className="section openend-technical profile-family-technical conti-technical-preview" data-openend-reveal><div className="container"><div className="openend-technical-grid openend-technical-grid--compact"><div className="internal-structure-image-col"><p className="internal-structure-label internal-structure-label--above">INTERNAL STRUCTURE</p><figure><img src={data.image} alt={data.alt} loading="lazy" decoding="async"/></figure></div><div className="openend-component-list internal-structure-list">{data.items.map((item,index)=><article key={item}><span>{index+1}</span><div><h3>{item}</h3></div></article>)}</div></div>{"properties" in data&&<div className="feature-columns"><div className="feature-column"><h4>Properties</h4><ul>{data.properties.map(item=><li key={item}>{item}</li>)}</ul></div><div className="feature-column"><h4>Profile Range</h4><ul>{data.ranges.map(item=><li key={item}>{item}</li>)}</ul></div></div>}</div></section>;
}
...
function TimingBeltDetailPage({slug}:{slug:TimingBeltDetailSlug}){
  ...
  return <>
    ...
    <section className="section openend-profiles" data-openend-reveal><div className="container">
      ...
      <div className={"openend-profile-catalog"+(slug==="rubber-open-end"?" rubber-openend-profile-catalog":"")}>{catalog.map((family:any)=><div key={family.family}><TimingProfileFamily family={family}/>{slug==="rubber-endless"&&<><ContiRubberTechnical family={family.family}/><RubberPerformanceTechnical family={family.family}/></>}</div>)}</div>
    </div></section>
